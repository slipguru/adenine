...
In this section we show how to use \ade to perform a exploratory analysis on a toy example. \ade requires as input a configuration file (with \texttt{.py}
extension) which looks like the following snippet.
