...
In this section we show how to use \ade to perform a exploratory analysis on a relatively small example. All we need is simply to install \ade and then run \texttt{ade\_run.py} on an input configuration file (with \texttt{.py} extension) which looks like the snippet below.
