...
{\sc ADENINE} is listed on the mloss forum\footnote{\url{http://mloss.org/software/}} and it is available from GitHub\footnote{\ulr{https://github.com/slipguru/adenine}}, the Python Package Index\footnote{\url{https://pypi.python.org/pypi/adenine/0.1.3}} and the webpage of the project \footnote{\url{http://slipguru.github.io/adenine/}}.
